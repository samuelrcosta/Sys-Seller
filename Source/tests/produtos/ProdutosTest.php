...
final class ProdutosTest extends PHPUnit_Extensions_Database_TestCase{
    ...
    public function getConnection()
    {
        if(!$this->conn) {
            ...
            $db->exec('CREATE TABLE `produtos` (`id` int(11) NOT NULL, `codigo` varchar(100) DEFAULT NULL, `nome` varchar(150) NOT NULL, `categoria` varchar(150) DEFAULT NULL, `descricao` text, `preco` double NOT NULL) ');
