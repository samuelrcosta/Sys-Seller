<div class="Container">
    <form method="POST" action="<?php echo BASE_URL ?>/produtos">
        <input style="margin: 5px" placeholder="Busque um produto..." type="text" class="form-control" id="busca" name="busca" value="<?=$termo;?>">
    </form>
